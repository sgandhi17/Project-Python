...
# Entry fields
entry =Entry(root, font=("arial", 20, "bold"), bg="orange", fg="black", bd=10, width=30)
entry.grid(row=0, column=0, columnspan=13)
...
for i in button_list:
    button =Button(root, width=5, height=2, bd=2, text=i, bg="white", fg="black",
